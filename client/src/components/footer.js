...
const Footer =  () => {
    ...
    return <footer id="footer">
        <div id="socialnewsbox">
          <div id="social">
            <a href="https://www.facebook.com/wyncode/" target="_blank" rel="noopener noreferrer">
              <img className="socialicons" src="https://leopolicastro.github.io/basic/if_facebook_28291.png" alt="facebookicon" />
            </a>
            <a href="https://www.linkedin.com/school/wyncode/" target="_blank" rel="noopener noreferrer">
              <img className="socialicons" src="https://leopolicastro.github.io/basic/if_linkedin_28298.png" alt="linkedinicon" />
            </a>
            <a href="https://twitter.com/wyncode?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank" rel="noopener noreferrer">
        ...
        <div id="footerlogo">
          <p>Wyncode Academy</p>
        <a href="https://wyncode.co/" target="_blank" rel="noopener noreferrer">
