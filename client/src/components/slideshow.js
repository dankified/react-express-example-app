        ...
        return (
            ...
            <Carousel.Item>
              ...
              <Carousel.Caption>
                ...
                <p>Huge space with a brewery, a taproom and an indoor/outdoor bar pouring signature and seasonal brews.</p>
              </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
              ...
              <Carousel.Caption>
                <h3>Proof Brewery</h3>
                <p>Proof Brewing Company is Tallahassee’s First and Largest Independently-Owned Production Brewery</p>
              </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
              ...
              <Carousel.Caption>
                <h3>Funky Buddha</h3>
                <p>Offering tours on weekends, this large craft brewery features a no-frills taproom with games.</p>
              </Carousel.Caption>
            </Carousel.Item>
          </Carousel>
        )
